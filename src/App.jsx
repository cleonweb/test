...
const platformAnalysis = {
  twitter: (username) => {
    ...
    const riskScore = isHighRisk ? 75 + Math.random() * 20 : 20 + Math.random() * 30;
    
    return {
      metrics: {
        tweets: Math.floor(1000 + Math.random() * 3000),
        followers: Math.floor(500 + Math.random() * 2000),
        following: Math.floor(300 + Math.random() * 1000),
        created_at: createdDate.toISOString(),
        engagement_rate: (5 + Math.random() * 15).toFixed(2),
      ...
      activity: {
        ...
        tweets_per_day: (8 + Math.random() * 12).toFixed(1),
        peak_hours: isHighRisk ? 'Automated' : 'Natural',
        suspicious_factors: isHighRisk ? [
          'Unusual posting patterns',
          'High frequency of retweets',
          'Limited original content',
          'Repetitive hashtag usage'
        ] : []
      },
      content: {
        duplication_rate: isHighRisk ? (70 + Math.random() * 20).toFixed(2) : (10 + Math.random() * 20).toFixed(2),
        similarity_score: isHighRisk ? (80 + Math.random() * 15).toFixed(2) : (20 + Math.random() * 30).toFixed(2),
        spam_probability: isHighRisk ? (75 + Math.random() * 20).toFixed(2) : (5 + Math.random() * 15).toFixed(2)
      },
      metadata: {
        status: isHighRisk ? 'Suspicious' : 'Valid',
        verification: Math.random() > 0.9 ? 'Verified' : 'Not Verified',
        profile_completeness: (70 + Math.random() * 30).toFixed(2)
      },
      evolution: {
        growth_rate: isHighRisk ? (80 + Math.random() * 20).toFixed(2) : (10 + Math.random() * 20).toFixed(2),
        follower_growth: isHighRisk ? (70 + Math.random() * 30).toFixed(2) : (5 + Math.random() * 15).toFixed(2),
        account_changes: isHighRisk ? Math.floor(5 + Math.random() * 5) : Math.floor(1 + Math.random() * 2)
      }
    };
  },
  instagram: (username) => {
    ...
    const isHighRisk = Math.random() > 0.7;
    const riskScore = isHighRisk ? 70 + Math.random() * 25 : 15 + Math.random() * 25;
    const usernameChanges = isHighRisk ? Math.floor(3 + Math.random() * 3) : Math.floor(1 + Math.random() * 2);
    
    return {
      metrics: {
        posts: Math.floor(50 + Math.random() * 200),
        stories: Math.floor(100 + Math.random() * 300),
        reels: Math.floor(20 + Math.random() * 50),
        followers: Math.floor(1000 + Math.random() * 5000),
        following: Math.floor(500 + Math.random() * 1000),
        created_at: createdDate.toISOString(),
        engagement_rate: (3 + Math.random() * 12).toFixed(2),
      ...
      activity: {
        pattern: isHighRisk ? 'Suspicious' : 'Normal',
        posts_per_day: (1 + Math.random() * 3).toFixed(1),
        story_frequency: isHighRisk ? 'Irregular' : 'Regular',
        suspicious_factors: isHighRisk ? [
          'Inconsistent posting schedule',
          'Unusual follower growth',
          'High spam comment activity',
          'Excessive hashtag usage'
        ] : []
      },
      content: {
        hashtag_usage: isHighRisk ? (80 + Math.random() * 20).toFixed(2) : (30 + Math.random() * 30).toFixed(2),
        caption_similarity: isHighRisk ? (75 + Math.random() * 20).toFixed(2) : (20 + Math.random() * 30).toFixed(2),
        spam_probability: isHighRisk ? (70 + Math.random() * 25).toFixed(2) : (10 + Math.random() * 20).toFixed(2)
      },
      metadata: {
        status: isHighRisk ? 'Suspicious' : 'Valid',
        verification: Math.random() > 0.9 ? 'Verified' : 'Not Verified',
        profile_completeness: (60 + Math.random() * 40).toFixed(2)
      },
      evolution: {
        ...
        previous_usernames: [
          `${username}_original`,
          `lifestyle_${username}`,
          `${username}_photography`,
          `real_${username}`
        ].slice(0, usernameChanges),
        growth_rate: isHighRisk ? (85 + Math.random() * 15).toFixed(2) : (15 + Math.random() * 25).toFixed(2)
      }
    };
  },
  facebook: (username) => {
    ...
    const isHighRisk = Math.random() > 0.7;
    const riskScore = isHighRisk ? 65 + Math.random() * 30 : 10 + Math.random() * 30;
    const nameChanges = isHighRisk ? Math.floor(3 + Math.random() * 3) : Math.floor(1 + Math.random() * 2);
    
    return {
      metrics: {
        posts: Math.floor(100 + Math.random() * 500),
        friends: Math.floor(200 + Math.random() * 800),
        followers: Math.floor(50 + Math.random() * 200),
        groups: Math.floor(5 + Math.random() * 20),
        created_at: createdDate.toISOString(),
        engagement_rate: (4 + Math.random() * 16).toFixed(2),
      ...
      activity: {
        pattern: isHighRisk ? 'Suspicious' : 'Normal',
        posts_per_day: (2 + Math.random() * 5).toFixed(1),
      ...
      content: {
        share_ratio: isHighRisk ? (85 + Math.random() * 15).toFixed(2) : (30 + Math.random() * 30).toFixed(2),
        original_content: isHighRisk ? (15 + Math.random() * 20).toFixed(2) : (60 + Math.random() * 30).toFixed(2),
        spam_probability: isHighRisk ? (70 + Math.random() * 25).toFixed(2) : (5 + Math.random() * 20).toFixed(2)
      },
      metadata: {
        status: isHighRisk ? 'Suspicious' : 'Valid',
        verification: Math.random() > 0.9 ? 'Verified' : 'Not Verified',
        profile_completeness: (50 + Math.random() * 50).toFixed(2)
      },
      evolution: {
        username_changes: nameChanges,
        previous_names: [
          `${username} Smith`,
          `${username} Johnson`,
          `${username} Williams`,
        ...
        growth_rate: isHighRisk ? (75 + Math.random() * 25).toFixed(2) : (10 + Math.random() * 30).toFixed(2)
      }
    };
  }
};
...
function App() {
  ...
  const handleAnalyze = async () => {
    ...
    const riskFactors = calculateRiskFactors({
      ...
      description: baseAnalysis.metadata.status === 'Suspicious' ? '' : 'Regular user description',
    ...
    const updatedAnalysis = {
      ...
      metrics: {
        ...
        risk_score: riskFactors.riskScore.toFixed(2)
      },
      activity: {
        ...baseAnalysis.activity,
        pattern: riskFactors.riskScore > 50 ? 'Suspicious' : 'Normal',
        suspicious_factors: riskFactors.factors
      }
    };
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <div className="flex items-center space-x-2 text-sm text-gray-500">
              ...
              {analysis.metadata.verification === 'Verified' && (
              ...
              {platform === 'twitter' && (
                <>
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="text-xl font-bold">{metrics.tweets.toLocaleString()}</div>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
              ...
              {platform === 'instagram' && (
                <>
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="text-xl font-bold">{metrics.posts.toLocaleString()}</div>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="text-sm text-gray-500">Stories</div>
                    <div className="text-xl font-bold">{metrics.stories.toLocaleString()}</div>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="text-sm text-gray-500">Reels</div>
                    <div className="text-xl font-bold">{metrics.reels.toLocaleString()}</div>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="text-sm text-gray-500">Followers</div>
                    <div className="text-xl font-bold">{metrics.followers.toLocaleString()}</div>
              ...
              {platform === 'facebook' && (
                <>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="text-xl font-bold">{metrics.friends.toLocaleString()}</div>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="text-sm text-gray-500">Groups</div>
                    <div className="text-xl font-bold">{metrics.groups.toLocaleString()}</div>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="text-sm text-gray-500">Followers</div>
                    <div className="text-xl font-bold">{metrics.followers.toLocaleString()}</div>
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className={`font-semibold ${getScoreColor(metrics.risk_score)}`}>
                    {metrics.risk_score}%
                  </span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    className={`h-2 rounded-full ${
                      parseFloat(metrics.risk_score) >= 70 ? 'bg-red-500' :
                      parseFloat(metrics.risk_score) >= 40 ? 'bg-yellow-500' :
                      'bg-green-500'
                    }`}
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className={`font-semibold ${getScoreColor(metrics.engagement_rate)}`}>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    ...
                    style={{ width: `${metrics.engagement_rate}%` }}
                  />
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className={`font-semibold ${getScoreColor(metrics.network_strength)}`}>
                    {metrics.network_strength}%
                  </span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    className="h-2 rounded-full bg-purple-500"
                    style={{ width: `${metrics.network_strength}%` }}
                  />
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className={`font-semibold ${getScoreColor(metrics.activity_consistency)}`}>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    ...
                    style={{ width: `${metrics.activity_consistency}%` }}
                  />
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium">{analysis.activity.posts_per_day}</span>
              </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-gray-50 p-3 rounded-lg">
                      ...
                      <div className="font-medium">
                        {analysis.activity.posts_per_day} posts/day
                      </div>
                    </div>
                    {platform === 'twitter' && (
                      <div className="bg-gray-50 p-3 rounded-lg">
